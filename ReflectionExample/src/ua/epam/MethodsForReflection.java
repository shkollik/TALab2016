...
public class MethodsForReflection {
    ...
    public void showConsructors(Constructor [] constructors){
        System.out.println("Constructors and their parametres of child class");
    ...
    public void showClassModifier(int modifier) {
        if (Modifier.isPublic(modifier)) {
            System.out.println("Modifier of Parent class is " + "public");
        }
        if (Modifier.isAbstract(modifier)) {
            System.out.println("Modifier of Parent class is " + "abstract");
        }
        if (Modifier.isFinal(modifier)) {
            System.out.println("Modifier of Parent class is " + "final");
        }
    }
